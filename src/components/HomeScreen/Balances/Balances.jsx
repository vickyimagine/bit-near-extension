  ...
  return (
    <div className="h-80 space-y-8 border-t border-gray-500 py-2 ">
      <div className="flex items-center justify-between px-5 py-1">
        ...
        <CopyToClipboard text={accountId}>
          ...
          >
            ...
            <RiFileCopyLine fontSize={21} color="#D8DD00" />
          </div>
        </CopyToClipboard>
      </div>
      ...
      <div className="flex justify-center items-center space-x-6 ">
        <Link to="/send" className="flex flex-col items-center space-y-2">
        ...
        <Link to="/receive" className="flex flex-col items-center space-y-2">
